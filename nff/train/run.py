...
class run():
    r"""
    The base script for running different 3DGN methods in DIG, which is from https://github.com/divelab/DIG/blob/dig-stable/dig/threedgraph/method/run.py.
    """
    def __init__(self):
        pass
    ...
    def run(self, device, train_dataset, valid_dataset, test_dataset, model, loss_func, evaluation, epochs=500, batch_size=32, vt_batch_size=32, lr=0.0005, lr_decay_factor=0.5, lr_decay_step_size=50, weight_decay=0, 
        energy_and_force=False, p=100, save_dir='', log_dir='',optimizer_state_dict=None,scheduler_state_dict=None):
        r"""
        ...
        if energy_and_force == False:
            print('[INFO] Energy model is training...')

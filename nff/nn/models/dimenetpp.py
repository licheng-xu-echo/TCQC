'''
The re-implementation for DimeNet++ from the https://github.com/divelab/DIG/blob/dig-stable/dig/threedgraph/method/dimenetpp/dimenetpp.py, to suit `nff` predcition
workflow
'''
...
from ..features import dist_emb, angle_emb,xyz_to_dat
...
class DimeNetPP(torch.nn.Module):
    ...
    def __init__(
        ...
        act=swish, output_init='GlorotOrthogonal',ret_res_dict=True):
